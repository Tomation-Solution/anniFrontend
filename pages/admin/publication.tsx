...
export default function News(){
    ...
    const { data,status,error} = useAppSelector(selectPublication);
    ...
    //   ];
    const getIntendedReader = (data:PublicationType):string=>{
    ...
    return (
        <DashboardLayout>
            ...
            <BasicModal handleClose={handleClose} open={open} body={<AddPublication handleClose={handleClose} />}/>
